...
Public Sub Form_Load()
    ...
    ' Create sprites:
    CreateSpriteResource cResChar, App.Path & "\lumberjack_s.bmp", 21, 1, &HFF00FF
    ...
    If (ItemObj.UBound > 0) Then
        ...
        Do While i <= ItemObj.UBound
            'NEWFORM
            If Level1x1_IntroText = False Or Level1x1_ItemDelcaration = False Then
                ...
                timeleft = 7314
                'NEWFORM
                ReDim Level1x1_Items(0 To i)
                'NEWFORM
                For DeclareItemArray = 0 To UBound(Level1x1_Items)
                    'NEWFORM
                    Level1x1_Items(DeclareItemArray).FileName = ItemObj(DeclareItemArray).Caption
                    Level1x1_Items(DeclareItemArray).ItemType = Mid(ItemObj(DeclareItemArray).Caption, 1, Len(ItemObj(DeclareItemArray).Caption) - 4)
                    'Level1x1_Items(DeclareItemArray).ItemType = ItemObj(DeclareItemArray).Caption
                    Level1x1_Items(DeclareItemArray).Used = False
            ...
            'End If
            'NEWFORM
            If (Level1x1_Items(i).Used = False) Then
                ...
                cItemObj(i).Cell = 1
            'NEWFORM
            ElseIf (Level1x1_Items(i).Used = True) Then
                CreateSpriteResource cResItemObj(i), App.Path & "\" & ItemObj(i).Caption, 2, 1, &HFF00FF
                CreateSprite cResItemObj(i), cItemObj(i)
                cItemObj(i).X = ItemObj(i).Left \ Screen.TwipsPerPixelX
                cItemObj(i).Y = ItemObj(i).Top \ Screen.TwipsPerPixelY
...
Public Function UseItem(ObjCollidedWith As Integer)
    ...
    'NEWFORM
    itemname = Level1x1_Items(ObjCollidedWith).ItemType
    ...
    Select Case itemname
        Case "chest"
            ...
            'NEWFORM
            If (Level1x1_Items(ObjCollidedWith).Used = True) Then
            ...
            'NEWFORM
            ElseIf (Level1x1_Items(ObjCollidedWith).Used = False) Then
                ...
                'Call showUserText("The chest was empty.", 2000)
                'NEWFORM
                Level1x1_Items(ObjCollidedWith).Used = True
            End If
        Case "healthbox"
            'healthbox used
