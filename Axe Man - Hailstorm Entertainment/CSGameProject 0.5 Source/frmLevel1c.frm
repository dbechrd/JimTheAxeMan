...
Begin VB.Form frmLevel1c 
   ...
   Begin VB.Image Image1 
      Height          =   9000
      Left            =   0
      Picture         =   "frmLevel1c.frx":1B31
      Top             =   0
      Visible         =   0   'False
      Width           =   12000
   End
End
Attribute VB_Name = "frmLevel1c"
...
Public Sub Form_Load()
    ...
    'NEWFORM
    If (previousLevel = 1.2) Then
        Unload frmLevel1b
    ElseIf (previousLevel = 1.4) Then
        Unload frmLevel1d
    End If
    ...
    If (ItemObj.UBound > 0) Then
        ...
        Do While i <= ItemObj.UBound
            ...
            End If
            'NEWFORM
            If Level1x3_IntroText = False Then
                Dim DeclareItemArray As Integer
                'NEWFORM
                ReDim Level1x3_Items(0 To i)
                'NEWFORM
                For DeclareItemArray = 0 To UBound(Level1x3_Items)
                    'NEWFORM
                    Level1x3_Items(DeclareItemArray).FileName = ItemObj(DeclareItemArray).Caption
                    Level1x3_Items(DeclareItemArray).ItemType = Mid(ItemObj(DeclareItemArray).Caption, 1, Len(ItemObj(DeclareItemArray).Caption) - 4)
                    'Level1x1_Items(DeclareItemArray).ItemType = ItemObj(DeclareItemArray).Caption
                    Level1x3_Items(DeclareItemArray).Used = False
            ...
            'End If
            'NEWFORM
            If (Level1x3_Items(i).Used = False) Then
                ...
                cItemObj(i).Cell = 1
            'NEWFORM
            ElseIf (Level1x3_Items(i).Used = True) Then
                CreateSpriteResource cResItemObj(i), App.Path & "\" & ItemObj(i).Caption, 2, 1, &HFF00FF
                CreateSprite cResItemObj(i), cItemObj(i)
                cItemObj(i).X = ItemObj(i).Left \ Screen.TwipsPerPixelX
                cItemObj(i).Y = ItemObj(i).Top \ Screen.TwipsPerPixelY
...
Public Function UseItem(ObjCollidedWith As Integer)
    ...
    'NEWFORM
    itemname = Level1x3_Items(ObjCollidedWith).ItemType
    ...
    Select Case itemname
        Case "chest"
            ...
            'NEWFORM
            If (Level1x3_Items(ObjCollidedWith).Used = True) Then
            ...
            'NEWFORM
            ElseIf (Level1x3_Items(ObjCollidedWith).Used = False) Then
                ...
                'Call showUserText("The chest was empty.", 2000)
                'NEWFORM
                Level1x3_Items(ObjCollidedWith).Used = True
            End If
        Case "healthbox"
            'healthbox used
