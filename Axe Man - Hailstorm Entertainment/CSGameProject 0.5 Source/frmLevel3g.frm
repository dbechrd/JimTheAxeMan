...
Public Sub Form_Load()
    ...
    'NEWFORM
    If (previousLevel = 3.6) Then
        Unload frmLevel3f
    ElseIf (previousLevel = 3.8) Then
        Unload frmLevel3h
    End If
    ...
    If (ItemObj.UBound > 0) Then
        ...
        Do While i <= ItemObj.UBound
            ...
            End If
            'NEWFORM
            If Level3x7_IntroText = False Then
                Dim DeclareItemArray As Integer
                'NEWFORM
                ReDim Level3x7_Items(0 To i)
                'NEWFORM
                For DeclareItemArray = 0 To UBound(Level3x7_Items)
                    'NEWFORM
                    Level3x7_Items(DeclareItemArray).FileName = ItemObj(DeclareItemArray).Caption
                    Level3x7_Items(DeclareItemArray).ItemType = Mid(ItemObj(DeclareItemArray).Caption, 1, Len(ItemObj(DeclareItemArray).Caption) - 4)
                    'Level1x1_Items(DeclareItemArray).ItemType = ItemObj(DeclareItemArray).Caption
                    Level3x7_Items(DeclareItemArray).Used = False
            ...
            'End If
            'NEWFORM
            If (Level3x7_Items(i).Used = False) Then
                ...
                cItemObj(i).Cell = 1
            'NEWFORM
            ElseIf (Level3x7_Items(i).Used = True) Then
                CreateSpriteResource cResItemObj(i), App.Path & "\" & ItemObj(i).Caption, 2, 1, &HFF00FF
                CreateSprite cResItemObj(i), cItemObj(i)
                cItemObj(i).X = ItemObj(i).Left \ Screen.TwipsPerPixelX
                cItemObj(i).Y = ItemObj(i).Top \ Screen.TwipsPerPixelY
...
Public Function UseItem(ObjCollidedWith As Integer)
    ...
    'NEWFORM
    itemname = Level3x7_Items(ObjCollidedWith).ItemType
    ...
    Select Case itemname
        Case "chest"
            ...
            'NEWFORM
            If (Level3x7_Items(ObjCollidedWith).Used = True) Then
            ...
            'NEWFORM
            ElseIf (Level3x7_Items(ObjCollidedWith).Used = False) Then
                ...
                'Call showUserText("The chest was empty.", 2000)
                'NEWFORM
                Level3x7_Items(ObjCollidedWith).Used = True
            End If
        Case "healthbox"
            'healthbox used
